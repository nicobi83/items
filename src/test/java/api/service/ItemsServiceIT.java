...
*/
    ...
    public void update() throws Exception {
        Items.Item item_add = new Items.Item();
        Items.Item item_update = new Items.Item();

        item_add.setId("add_update");
        item_update.setId("update_test");
    ...
    public void getItem() throws Exception {
        ...
        item.setId(id1);
        service.add(item);
        Items.Item temp_item = new Items.Item();
    ...
    public void findItems() throws Exception {
        List<Items.Item> ls = new ArrayList<>();
